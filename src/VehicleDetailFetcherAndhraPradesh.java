...
public class VehicleDetailFetcherAndhraPradesh extends VehicleDetailFetcher {
	...
	public static void main(String[] args) throws FailingHttpStatusCodeException, MalformedURLException, IOException, InterruptedException {
		...
		System.out.println(v.getVehicleDetailsFromService("AP13R5977").getOwnerName());
	}
	...
	ArrayList<String> vehicleDetailsList = new ArrayList<String>();
		...
		{
			/*
			if(str.contains("Registration No"))
			{
				String fuelType = str.substring(str.indexOf("Fuel Type:"));
				
				fuelType=	fuelType.replace("Fuel Type:", "").trim();
				
				
			}
			if(str.contains("Owner Name:"))
			{
				String vehicleColor = str.substring(str.indexOf("Vehicle Color:"));
			...
			if(str.contains("Registration No:"))
			{
				String makersName = str.substring(str.indexOf("Maker's Name:"));
			...
			*/
			...
			vehicleDetailsList.add(s[1]);
			vehicleDetailsList.add(s[3]);
		...
		vehicleObj.setDateofRegistration(vehicleDetailsList.get(6));

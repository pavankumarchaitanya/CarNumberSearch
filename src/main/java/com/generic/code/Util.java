...
public class Util {
	...
	public static String FetchInitialPageAsHTML(String URLToFetch,
			String Parameters) {
	...
	public static String doGet(String URLToGet, String urlParameters)
			throws IOException {
		String response = "";
	...
	public static String doPost(String URLToPost, String urlParameters)
			throws IOException {
	...
	public static String doHttpsPost(String URLToPost, String urlParameters)
			throws IOException {
		 ...
		 * System.out.print( (char)c ); response +=(char)c ;
		 * 
		 * }
		 * 
		 * input.close();
	...
	public static String httpsPost(String URLToPost, String urlParameters)
			throws IOException {
		String httpsURL = URLToPost;// "https://www.abcd.com/auth/login/";
